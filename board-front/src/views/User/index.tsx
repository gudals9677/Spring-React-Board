...
export default function User() {
  ...
  //      state: userEmail pathvariable 상태       //
  ...
  const UserTop = () => {
    ...
    //      effect: email path varibale 변경 시 실행 할 함수         //
    useEffect(() => {
      ...
      <div id='user-top-wrapper'>
        <div className='user-top-container'>
          ...
          <div className='user-top-info-box'>
            ...
            <div className='user-top-info-email'>{'gudals9677@email.com'}</div>
          </div>
        </div>
      </div>
    );
  ...
  const UserBottom = () => {
    ...
    //      effect: userEmail pathvariable 변경 될 때 마다 실행 할 함수      //
    useEffect(() => {
      if (!userEmail) return;
